...
/**
 * \brief This funtions generates code of inserted functions 
 *
*/
void create_functions();
/**
 * \brief This function creates the end of the main function, pops frame and clears the stack
 * 
 
*/
void end_main();
/**
 * \brief This function creates a code for the begging of the definitions of the functions
 *
...
/**
 * \brief This function creates a local frame return value
 *
 * \param[in] str String for code
...
/**
 * \brief This function creates parameters for function definition
 *
 * \param[in] token Input token
...
/**
 * \brief This function creates ending for function definition
 * 
 * \param[in] token Input token
 * \param[in] str String for code
...
/**
 * \brief This function creates the variables definitions in all frames
 * 
 * \param[in] token Input token
 * \param[in] s char for frame choosing
 * \param[in] str String for code
...
/**
 * \brief This function assignes variables to identificators in all frames
 * 
 * \param[in] token Input token
...
/**
 * \brief This function creates the frame for function call
 *
 * \param[in] str String for code
...
/**
 * \brief This function passes arguments and values of the arguments to a function (when the functions is called)
 * 
 * \param[in] token Input token
 * \param[in] counter Int for arguments count 
 * \param[in] s char for frame choosing
...
/**
 * \brief This function generates function call
 *
 * \param[in] token Input token
 * \param[in] str String for code
...
/**
 * \brief This function generates global frame return value assignment to an identifier
 *
 * \param[in] token Input token
 * \param[in] s char for frame choosing
 * \param[in] str String for code
...
/**
 * \brief This function prints float value
 *
...
/**
 * \brief This function prints int value
 *
 * \param[in] token_write Input token
 * \param[in] str String for code
...
/**
 * \brief This function prints string
 *
 * \param[in] token_write Input token
 * \param[in] str String for code
...
/**
 * \brief This function prints "None"
 *
 * \param[in] token_write Input token
 * \param[in] str String for code
...
/**
 * \brief This function prints identifier
 *
 * \param[in] token_write Input token
 * \param[in] str String for code
...
/**
 * \brief This function prints space
 *
 * \param[in] str String for code
...
/**
 * \brief This function prints new line
 *
 * \param[in] str String for code
...
/**
 * \brief This function prints if condition's beggining
 *
 * \param[in] str String for code
...
/**
 * \brief This function generates if conditon's body
 * 
 * \param[in] str String for code
...
/**
 * \brief This function generates else conditon's body in case if it is found
 * 
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions 
 * \param[in] str String for code
 
*/
void found_else(int *t,struct dynamic_string *str);
/**
 * \brief This function generates end of if's condition
 * 
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
...
/**
 * \brief This function generates end of else's condition
 * 
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
...
/**
 * \brief This function generates the beggining of while cycle
 *
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
...
/**
 * \brief This function generates the body of while cycle
 *
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
...
/**
 * \brief This function generates the end of while cycle
 *
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
...
/**
 * \brief This function generates the beggining of the while cycle for the case of constant arguments of while(unchanged)
 * 
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
*/
...
/**
 * \brief This function generates the end of while cycle for constant arguments
 * \param[in] t Int for couting the amount of while's and if's condition in while's and if's codintions
 * \param[in] str String for code
...
/**
 * \brief This function works with 2 upper elements in stack
 * Performs operatons such as SUM, MULTIPLY, MINUS, DIVISION, IDIV,EQUAL,NOT_EQUAL GREATER, LESS, LESS_EQ, TOKEN_GREATER_EQ
 * 
...
/**
 * \brief This function generates PUSH in the stack
 *
 * \param[in] token_type Input token
 * \param[in] str String for code
*/
...
/**
 * \brief This function generates helping variables for operations with stacks
 *
 * \param[in] token_type Input token
 * \param[in] str String for code
*/
...
/**
 * \brief This function generates the call of inputs function
 *
 * \param[in] str String for code
...
/**
 * \brief This function generates the call of inputi function
 *
 * \param[in] str String for code
...
/**
 * \brief This function generates the call of inputf function
 *
 * \param[in] str String for code
...
/**
 * \brief This function generates the call of all inserted function except inputi(f,s) 
 *
 * \param[in] str String for code
