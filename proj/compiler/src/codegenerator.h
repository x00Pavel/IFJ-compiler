...
/**
 * \brief This function creates the end of the main function, pops frame and
 clears the stack
 *
*/
void end_main();
/**
 * \brief This function creates a code for the begging of the definitions of the
 functions
 *
...
/**
 * \brief This function passes arguments and values of the arguments to a
...
/**
 * \brief This function generates global frame return value assignment to an
 * identifier
 *
 * \param[in] token Input token
 * \param[in] s char for frame choosing
 ...
 *
 * \param[in] t Int for couting the amount of while's and if's condition in
 while's and if's codintions
 * \param[in] str String for code
*/
...
/**
 * \brief This function generates the beggining of the while cycle for the case
 * of constant arguments of while(unchanged)
 *
 * \param[in] t Int for couting the amount of while's and if's condition in
 * while's and if's codintions \param[in] str String for code
 */
 ...
 * Performs operatons such as SUM, MULTIPLY, MINUS, DIVISION,
 * IDIV,EQUAL,NOT_EQUAL GREATER, LESS, LESS_EQ, TOKEN_GREATER_EQ
 *
...
/**
 * \brief This function generates the call of all inserted function except
 inputi(f,s)
 *
 * \param[in] str String for code
