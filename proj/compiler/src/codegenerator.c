...
void create_functions(){
  ...
  fprintf(stdout, "#INPUTS\n");
    ...
    fprintf(stdout, "MOVE LF@%%retval LF@%%var\n");
...
*/
    ...
    void create_returnvalue(struct dynamic_string *str){
        ...
        // else
        // {
        //     for(unsigned int i = 0; i < strlen("DEFVAR GF"); i++){
        //         add_char_to_str(str, "DEFVAR GF"[i]);
        //     }
        //     for(unsigned int i = 0; i < strlen("@res\n"); i++){
        //         add_char_to_str(str, "@res\n"[i]);
        //     }
...
void prec_an_operand(char *s, struct token_s *token, struct dynamic_string *str){
    ...
    case TOKEN_INT:
        ...
        else
        {
            ...
            for(unsigned int i = 0; i < strlen(token->attribute.int_val); i++){
                add_char_to_str(str, token->attribute.int_val[i]);
            }  
            add_char_to_str(str, 10);
            break;
        }
    case TOKEN_FLOAT:
        ...
        else
        {
            ...
            for(unsigned int i = 0; i < strlen(token->attribute.float_val); i++){
                add_char_to_str(str, token->attribute.float_val[i]);
        }  
            add_char_to_str(str, 10);
            break;
        }
...
void prec_an_operator(token_t type, struct dynamic_string *str){
    ...
    case TOKEN_SUM:
        ...
        else
        {
            ...
            for(unsigned int i = 0; i < strlen(tmp14tmp14); i++){
            ...
            char tnp15[100];
            sprintf(tnp15, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tnp15); i++){
                add_char_to_str(str, tnp15[i]);
            }
    ...
    case TOKEN_MINUS:
        ...
        else
        {
            ...
            add_char_to_str(str, 10);
            for(unsigned int i = 0; i < strlen("\nINT2FLOAT GT@prec_var_temp_2 GF@prec_var_temp_2\nLABEL $MINUS_SKIP_"); i++){
                add_char_to_str(str,   "\nINT2FLOAT GT@prec_var_temp_2 GF@prec_var_temp_2\nLABEL $MINUS_SKIP_"[i]);
            }
            char tmp36[100];
    ...
    case TOKEN_MULTIPLY:
        ...
        else
        {
            ...
            for(unsigned int i = 0; i < strlen("MUL GF@prec_var_temp_1 GF@rpec_var_temp_2 GF@prec_var_temp_1\nPUSHS GF@prec_var_temp_1\n"); i++){
                add_char_to_str(str,   "MUL GF@prec_var_temp_1 GF@rpec_var_temp_2 GF@prec_var_temp_1\nPUSHS GF@prec_var_temp_1\n");
            } 
    ...
    case TOKEN_EQUAL:
        ...
        {
          for(unsigned int i = 0; i < strlen("POPS GF@prec_var_temp_1\nTYPE GF@type_var_1 GF@prec_var_temp_1\nPOPS GF@prec_var_temp_2\nTYPE GF@type_var_2 GF@prec_var_temp_2\nJUMPIFNEQ $EQ_SKIP_"); i++){
                add_char_to_str(str, "POPS GF@prec_var_temp_1\nTYPE GF@type_var_1 GF@prec_var_temp_1\nPOPS GF@prec_var_temp_2\nTYPE GF@type_var_2 GF@prec_var_temp_2\nJUMPIFNEQ $EQ_SKIP"_[i]);
            }    
            char tmp59[100];
            sprintf(tmp59, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp59); i++){
            ...
            char tmp60[100];
            sprintf(tmp60, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp60); i++){
                add_char_to_str(str, tmp60[i]);
            }
            for(unsigned int i = 0; i < strlen("\nJUMPIFNEQ $skip_eq"); i++){
                add_char_to_str(str,   "\nJUMPIFNEQ $skip_eq_"[i]);
            } 
            char tmp61[100];
            ...
            for(unsigned int i = 0; i < strlen("\nINT2FLOAT GT@prec_var_temp_2 GF@prec_var_temp_2"); i++){
                add_char_to_str(str,   "\nINT2FLOAT GT@prec_var_temp_2 GF@prec_var_temp_2"[i]);
            } 
            char tmp68[100];
            sprintf(tmp68, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp68); i++){
                add_char_to_str(str, tmp68[i]);
            } 
            ...
            for(unsigned int i = 0; i < strlen("\nEQ GF@prec_var_temp_1 GF@prec_var_temp_2 GF@prec_var_temp_1\nPUSHS GF@prec_var_temp_1"); i++){
                add_char_to_str(str,  "\nEQ GF@prec_var_temp_1 GF@prec_var_temp_2 GF@prec_var_temp_1\nPUSHS GF@prec_var_temp_1"[i]);
            } 
    ...
    case TOKEN_NOT_EQUAL:
        ...
        else
        {
            ...
            char tmp76[100];
            sprintf(tmp76, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp76); i++){
                add_char_to_str(str, tmp76[i]);
            } 
            for(unsigned int i = 0; i < strlen("\nJLABEL $skip_ne_"); i++){
                add_char_to_str(str,   "\nJLABEL $skip_ne_"[i]);
            } 
            ...
            for(unsigned int i = 0; i < strlen(" GF@prec_var_2 GF@type_var_1\nPUSH bool@false\nJUMP $END_AFTER_NE_"); i++){
                add_char_to_str(str,   " GF@prec_var_2 GF@type_var_1\nPUSH bool@false\nJUMP $END_AFTER_NE_"[i]);
            } 
            char tmp81[100];
            ...
            char tmp82[100];
            sprintf(tmp82, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp82); i++){
                add_char_to_str(str, tmp82[i]);
            }
            for(unsigned int i = 0; i < strlen("\nLABEL $NOT_EQUAL_"); i++){
                add_char_to_str(str,   "\nLABEL $NOT_EQUAL_"[i]);
            } 
    ...
    case TOKEN_LESS:
        ...
        {
          for(unsigned int i = 0; i < strlen("POPS GF@prec_var_temp_1\nTYPE GF@type_var_1 GF@prec_var_temp_1\nPOPS GF@prec_var_temp_2\nTYPE GF@type_var_2 GF@prec_var_temp_2\nJUMPIFNEQ $LS_SKIP_"); i++){
                add_char_to_str(str, "POPS GF@prec_var_temp_1\nTYPE GF@type_var_1 GF@prec_var_temp_1\nPOPS GF@prec_var_temp_2\nTYPE GF@type_var_2 GF@prec_var_temp_2\nJUMPIFNEQ $LS_SKIP"_[i]);
            }    
            char tmp85[100];
            ...
            char tmp86[100];
            sprintf(tmp86, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp86); i++){
                add_char_to_str(str, tmp86[i]);
            }
            for(unsigned int i = 0; i < strlen("\nJUMPIFNEQ $skip_ls"); i++){
                add_char_to_str(str,   "\nJUMPIFNEQ $skip_ls"[i]);
            } 
            ...
            char tmp94[100];
            sprintf(tmp94, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp94); i++){
                add_char_to_str(str, tmp94[i]);
            } 
            ...
            for(unsigned int i = 0; i < strlen("\nLS GF@prec_var_temp_1 GF@prec_var_temp_2 GF@prec_var_temp_1\nPUSHS GF@prec_var_temp_1"); i++){
                add_char_to_str(str,  "\nLS GF@prec_var_temp_1 GF@prec_var_temp_2 GF@prec_var_temp_1\nPUSHS GF@prec_var_temp_1"[i]);
            }             
            skip_counter++;
            break;
    ...
    case TOKEN_GREATER:
        ...
        else
        {
            ...
            char tmp97[100];
            sprintf(tmp97, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp97); i++){
                add_char_to_str(str, tmp97[i]);
            }
            for(unsigned int i = 0; i < strlen("\nJUMPIFNEQ $skip_gt"); i++){
                add_char_to_str(str,   "\nJUMPIFNEQ $skip_gt"[i]);
            } 
            ...
            char tmp105[100];
            sprintf(tmp105, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp105); i++){
                add_char_to_str(str, tmp105[i]);
            } 
    ...
    case TOKEN_LESS_EQ:
        ...
        else
        {
            ...
            char tmp108[100];
            sprintf(tmp108, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp108); i++){
                add_char_to_str(str, tmp108[i]);
            }
            for(unsigned int i = 0; i < strlen("\nJUMPIFNEQ $skip_ls_eq"); i++){
                add_char_to_str(str,   "\nJUMPIFNEQ $skip_ls_eq"[i]);
            } 
            char tmp109[100];
            ...
            char tmp116[100];
            sprintf(tmp116, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp116); i++){
                add_char_to_str(str, tmp116[i]);
            } 
            ...
            char tmp119[100];
            sprintf(tmp119, "%d", skip_counter);
            for(unsigned int i = 0; i < strlen(tmp119); i++){
                add_char_to_str(str, tmp119[i]);
            }
            for(unsigned int i = 0; i < strlen("\nPUSHS GF@prec_var_temp_1\n"); i++){
                add_char_to_str(str,  "\nPUSHS GF@prec_var_temp_1\n"[i]);
            }  
